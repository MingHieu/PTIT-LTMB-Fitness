...
import com.ltmb.fitness.databinding.FragmentRankingTotaltrainingdayBinding;
...
public class RankingFragmentTotalTrainingDayd extends BaseFragment<RankingViewModel, FragmentRankingTotaltrainingdayBinding> {
    private final FirebaseFirestore fireStore = FirebaseFirestore.getInstance();
    @Override
    public int getLayoutId() {
        return R.layout.fragment_ranking_totaltrainingday;
    }
    ...
    private List<RankingPersonUiModel> fetchData() throws ExecutionException, InterruptedException {
        ...
        for (QueryDocumentSnapshot document : snapshot) {
            ...
            if(users.containsKey(id)) {
                ...
                long time = rankingPersonUiModel.getExperience() + workoutHistoryModel.getWorkouts();
