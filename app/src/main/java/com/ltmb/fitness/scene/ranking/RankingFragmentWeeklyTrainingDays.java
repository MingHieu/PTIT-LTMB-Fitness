...
import com.ltmb.fitness.databinding.FragmentRankingWeeklytrainingdaysBinding;
...
public class RankingFragmentWeeklyTrainingDays extends BaseFragment<RankingViewModel, FragmentRankingWeeklytrainingdaysBinding> {
    private final FirebaseFirestore fireStore = FirebaseFirestore.getInstance();
    @Override
    public int getLayoutId() {
        return R.layout.fragment_ranking_weeklytrainingdays;
    }
    ...
    private List<RankingPersonUiModel> fetchData() throws ExecutionException, InterruptedException {
        ...
        for (QueryDocumentSnapshot document : snapshot) {
            ...
            if(users.containsKey(id)) {
                ...
                long time = rankingPersonUiModel.getExperience() + workoutHistoryModel.getKcal();
